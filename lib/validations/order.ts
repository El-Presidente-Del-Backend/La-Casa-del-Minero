...
/**
 * name/phone/email son opcionales a nivel de schema: la obligatoriedad depende
 * de si el comprador tiene sesión activa, algo que el schema no puede saber.
...
export const createOrderSchema = z.object({
  ...
  email: z.string().trim().email("Ingresa un email válido").optional(),
  phone: z
    .string()
    .trim()
